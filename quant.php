<?
// Пример базовых вычислений для таблицы http://on.fb.me/1ICrbZR

$Misl="квант"; // (мысль - смысл, идея, образ (группа, кластер), вопрос, ответ, сообщение, название, имя, существительное)
